...
LOGIN_SERVICE_PROVIDER_PROD_cert
LOGIN_SERVICE_PROVIDER_PROD_issuer
LOGIN_SERVICE_PROVIDER_PROD_private
LOGIN_SERVICE_PROVIDER_PROD_decryptCert
...
LOGIN_SERVICE_PROVIDER_DEV_cert
LOGIN_SERVICE_PROVIDER_DEV_issuer
LOGIN_SERVICE_PROVIDER_DEV_private
LOGIN_SERVICE_PROVIDER_DEV_decryptCert
